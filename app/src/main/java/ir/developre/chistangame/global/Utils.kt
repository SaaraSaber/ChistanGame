...
object Utils {
    ...
    //...................poolakey
    const val rsaPublicKey = ""
    const val productId_50 = "coin1"
    const val productId_80 = "coin1"
    const val productId_100 = "coin1"
    const val productId_150 = "coin1"
    const val productId_300 = "coin1"
